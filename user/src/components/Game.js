...
function Game() {
    ...
    useEffect(() => {
        if (!isTwoPlayerMode && currentPlayer === aiSymbol && status === "ongoing") {
            makeAIMove();
        }
    ...
    useEffect(() => {
        if (!isTwoPlayerMode && humanSymbol === "O" && board.flat().every(cell => cell === "")) {
            makeAIMove();
        }
    }, []);
    ...
    const checkGameStatus = () => {
        ...
        for (let line of lines) {
            ...
            if (
                ...
                if (!isTwoPlayerMode) {
                    setStatus(winnerSymbol === aiSymbol ? "AI wins" : "Player wins");
                } else {
                    setStatus(`Player ${winnerSymbol} wins`);
                }
